...
const ENTRIES = [
  ...
  { time: '13:48:17', actor: 'compliance@firm.nz', action: 'DEAL_VERIFIED',     tone: 'primary',
    summary: 'Review started' },
  { time: '13:11:42', actor: 'broker1@firm.nz',    action: 'DEAL_SUBMITTED_FOR_REVIEW',    tone: 'primary',
